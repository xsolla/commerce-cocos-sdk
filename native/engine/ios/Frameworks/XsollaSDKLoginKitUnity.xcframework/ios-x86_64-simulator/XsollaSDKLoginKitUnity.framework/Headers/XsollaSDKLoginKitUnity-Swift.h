...
#ifndef XSOLLASDKLOGINKITUNITY_SWIFT_H
#define XSOLLASDKLOGINKITUNITY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XsollaSDKLoginKitUnity",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Authorization info
SWIFT_CLASS("_TtC22XsollaSDKLoginKitUnity15AccessTokenInfo")
...
SWIFT_CLASS("_TtC22XsollaSDKLoginKitUnity19JWTGenerationParams")
...
SWIFT_CLASS("_TtC22XsollaSDKLoginKitUnity13LoginKitUnity")
@interface LoginKitUnity : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LoginKitUnity * _Nonnull shared;)
+ (LoginKitUnity * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
@interface LoginKitUnity (SWIFT_EXTENSION(XsollaSDKLoginKitUnity))
...
SWIFT_CLASS("_TtC22XsollaSDKLoginKitUnity44WebAuthenticationPresentationContextProvider") SWIFT_AVAILABILITY(ios,introduced=13.4)
